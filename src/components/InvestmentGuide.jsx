    ...
    <section className="guide-section py-5 bg-dark text-white">
      <div className="container py-5">
        <h2 className="display-5 fw-light mb-5">
          <span className="fw-bold">Begin your investment</span>{" "}
          <span className="fst-italic text-secondary opacity-75">with confidence</span>
        </h2>
        ...
        <div className="row g-5">
          ...
          <div className="col-lg-5 border-end border-secondary border-opacity-25 pe-lg-5">
            <div className="d-flex align-items-center mb-4">
              <span
                className="badge bg-danger rounded-circle p-0 d-flex align-items-center justify-content-center fw-bold me-3"
            ...
            <Link
              to="/about" // points to About page
              className="btn btn-danger btn-lg rounded-pill px-5 py-2 shadow-sm border-0"
            >
              Learn more ↗
            </Link>
          </div>
          ...
          <div className="col-lg-7 ps-lg-5">
            ...
            <div className="row g-4">
              ...
              <div className="col-md-6 mb-3">
                <h5 className="fw-bold text-white mb-2 border-start border-danger border-3 ps-3">
                  Market Promotion
                </h5>
